...
const ProductModal: React.FC<ModalProps> = ({ closeModal }: ModalProps) => {
  ...
  const handleChange = (
    ...
    setData({
      ...data,
      [name]:
        name === "productImage" && e.target instanceof HTMLInputElement
            ...
            <div className="flex justify-between">
              <div>
                ...
                <input
                  ...
                  type="file"
                  id="website_url"
                  className="w-[220px] mt-1 p-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500"
                  required
                />
              </div>
              <div>
                ...
                <select
                  ...
                  name="categoryId"
                  id=""
                  className="w-[170px] h-[50px] border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 re"
                >
                  {items.length > 0 &&
                    items.map((item) => {
                      return (
